...
const IndexPage = (props) => (
  <Layout>
    <Section>
      ...
      <SubHeading>Why don't you read some random facts about Darkness <Link to="/random-facts"><span className="MainText">here.</span><span className="HoverText">here.</span></Link></SubHeading>
